...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	 ...
	 */
	$g_administrator_email	= 'dsjin@smart-systems.com.cn';

	/**
	 * Webmaster email
	 * @global string $g_webmaster_email
	 */
	$g_webmaster_email		= 'dsjin@smart-systems.com.cn';

	/**
	 * the sender email, part of 'From: ' header in emails
	 * @global string $g_from_email
	 */
 	$g_from_email			= 'dsjin@smart-systems.com.cn';

	/**
	 * the sender name, part of 'From: ' header in emails
	 * @global string $g_from_name
	 */
	$g_from_name			= 'Smart Systems Mantis Bug Tracker';

	/**
	 * the return address for bounced mail
	 * @global string $g_return_path_email
	 */
	$g_return_path_email	= 'dsjin@smart-systems.comm.cn';
	 ...
	 */
	$g_absolute_path_default_upload_folder = '/opt/lampp/htdocs/bugtracker/upload/'; #New creat DIR upload
	 ...
	 */
	$g_relationship_graph_fontsize		= 18;
